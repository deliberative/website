...
>
  <h1>Privacy Policy for Deliberative Technologies P.C.</h1>

  <p>
    At Deliberative, accessible from https://deliberative.io, one of our main priorities is the
    privacy of our visitors. This Privacy Policy document contains types of information that is
    collected and recorded by Deliberative and how we use it.
  </p>
  ...
  <p>
    ...
    website with regards to the information that they shared and/or collect in Deliberative. This
  ...
  <p>
    Deliberative follows a standard procedure of using log files. These files log visitors when they
  ...
  <p>
    Like any other website, Deliberative uses "cookies". These cookies are used to store information
  ...
  <p>
    ...
    that are used in their respective advertisements and links that appear on Deliberative, which
  ...
  <p>
    Note that Deliberative has no access to or control over these cookies that are used by
  ...
  <p>
    Deliberative's Privacy Policy does not apply to other advertisers or websites. Thus, we are
  ...
  <p>
    Deliberative does not knowingly collect any Personal Identifiable Information from children
