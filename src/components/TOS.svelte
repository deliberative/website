<article
  class="prose dark:prose-invert mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24"
>
  <h2><strong>Terms and Conditions</strong></h2>

  <p>Welcome to Deliberative!</p>

  <p>
    These terms and conditions outline the rules and regulations for the use of Deliberative
    Technologies P.C.'s Website, located at https://deliberative.io.
  </p>

  <p>
    By accessing this website we assume you accept these terms and conditions. Do not continue to
    use Deliberative if you do not agree to take all of the terms and conditions stated on this
    page.
  </p>
  ...
  <p>
    ...
    Company's stated services, in accordance with and subject to, prevailing law of gr. Any use of
  ...
  <p>
    We employ the use of cookies. By accessing Deliberative, you agreed to use cookies in agreement
    with the Deliberative Technologies P.C.'s Privacy Policy.
  </p>
  ...
  <p>
    Unless otherwise stated, Deliberative Technologies P.C. and/or its licensors own the
    intellectual property rights for all material on Deliberative. All intellectual property rights
    are reserved. You may access this from Deliberative for your own personal use subjected to
    restrictions set in these terms and conditions.
  </p>

  <p>You must not:</p>
  <ul>
    <li>Republish material from Deliberative</li>
    <li>Sell, rent or sub-license material from Deliberative</li>
    <li>Reproduce, duplicate or copy material from Deliberative</li>
    <li>Redistribute content from Deliberative</li>
  </ul>

  <p>
    This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the
    help of the <a href="https://www.termsfeed.com/terms-conditions-generator/"
  ...
  <p>
    ...
    information in certain areas of the website. Deliberative Technologies P.C. does not filter,
    edit, publish or review Comments prior to their presence on the website. Comments do not reflect
    the views and opinions of Deliberative Technologies P.C.,its agents and/or affiliates. Comments
    reflect the views and opinions of the person who post their views and opinions. To the extent
    permitted by applicable laws, Deliberative Technologies P.C. shall not be liable for the
  ...
  <p>
    Deliberative Technologies P.C. reserves the right to monitor all Comments and to remove any
  ...
  <p>
    You hereby grant Deliberative Technologies P.C. a non-exclusive license to use, reproduce, edit
  ...
  <p>
    ...
    hyperlink compensates the absence of Deliberative Technologies P.C.; and (d) the link is in the
  ...
  <p>
    ...
    our website, you must inform us by sending an e-mail to Deliberative Technologies P.C.. Please
  ...
  <p>
    No use of Deliberative Technologies P.C.'s logo or other artwork will be allowed for linking
